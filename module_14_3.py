...
async def get_buying_list(message):
    prod = (['Витамин A', 'Описание A', 100],
            ['Витамин B','Описание B', 200],
            ['Витамин C', 'Описание C', 300],
            ['Витамин D', 'Описание D', 400])
    for vit, info, price in prod:
        with open('./vitamin-c.jpg', 'rb') as img:
            await message.answer_photo(img, f'Название: {vit} | Описание: {info} | Цена: {price}')
    await message.answer('Выберите продукт для покупкиЖ', reply_markup=kb_i)
